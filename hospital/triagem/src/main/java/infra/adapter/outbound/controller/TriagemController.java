package infra.adapter.outbound.controller;

import application.useCase.inbound.alterarTriagem.AlterarTriagem;
import application.useCase.inbound.alterarTriagem.AlterarTriagemOutput;
import application.useCase.inbound.consultarTriagem.ConsultarTriagem;
import application.useCase.inbound.consultarTriagem.ConsultarTriagemOutput;
import application.useCase.inbound.gerarTriagem.GerarTriagem;
...
import infra.adapter.inbound.dto.AlterarTriagemDTO;
import infra.adapter.inbound.dto.GerarTriagemDTO;
