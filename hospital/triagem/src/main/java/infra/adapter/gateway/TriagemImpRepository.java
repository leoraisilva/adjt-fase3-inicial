package infra.adapter.gateway;

import application.domain.Triagem;
import application.useCase.outbound.TriagemRepository;
import infra.adapter.inbound.mapper.ITriagemMapper;
import infra.adapter.outbound.persistent.repository.AnamneseJPARepository;
import infra.adapter.outbound.persistent.repository.AvaliacaoJPARepository;
import infra.adapter.outbound.persistent.repository.TriagemJPARepository;
